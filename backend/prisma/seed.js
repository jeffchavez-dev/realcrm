...
async function main() {
  ...
  // ── LEADS ─────────────────────────────────────────────────────────
  const leadsData = [
    { firstName:'Michael', lastName:'Thompson', email:'m.thompson@gmail.com', phone:'(240) 555-0201', source:'Google PPC', status:'Hot', score:87, temperature:'Hot', budget:650000, preApproved:true, timeline:'1-3 months', agentId:sarah.id, tags:'buyer,pre-approved,urgent', lastContact: new Date(Date.now() - 1*24*60*60*1000) },
    { firstName:'Jennifer', lastName:'Walsh', email:'jen.walsh@outlook.com', phone:'(301) 555-0202', source:'Upnest', status:'Nurturing', score:64, temperature:'Warm', budget:420000, preApproved:false, timeline:'3-6 months', agentId:marcus.id, tags:'buyer,first-time', lastContact: new Date(Date.now() - 3*24*60*60*1000) },
    { firstName:'Robert', lastName:'Kim', email:'r.kim@yahoo.com', phone:'(703) 555-0203', source:'Facebook', status:'Contacted', score:45, temperature:'Warm', budget:525000, preApproved:false, timeline:'6-12 months', agentId:diana.id, tags:'buyer,relocating', lastContact: new Date(Date.now() - 5*24*60*60*1000) },
    { firstName:'Amanda', lastName:'Foster', email:'afoster@gmail.com', phone:'(202) 555-0204', source:'Referral', status:'Hot', score:92, temperature:'Hot', budget:875000, preApproved:true, timeline:'Immediately', agentId:priya.id, tags:'buyer,luxury,pre-approved', lastContact: new Date(Date.now() - 0.5*24*60*60*1000) },
    { firstName:'David', lastName:'Martinez', email:'d.martinez@gmail.com', phone:'(240) 555-0205', source:'Google PPC', status:'New', score:22, temperature:'Cold', budget:380000, preApproved:false, timeline:'12+ months', agentId:james.id, tags:'buyer', lastContact: null },
    { firstName:'Lisa', lastName:'Anderson', email:'lisa.a@gmail.com', phone:'(301) 555-0206', source:'Homelight', status:'Nurturing', score:58, temperature:'Warm', budget:495000, preApproved:false, timeline:'3-6 months', agentId:marcus.id, tags:'seller,buyer', lastContact: new Date(Date.now() - 7*24*60*60*1000) },
    { firstName:'Kevin', lastName:'Brown', email:'k.brown@gmail.com', phone:'(571) 555-0207', source:'FastExpert', status:'Contacted', score:39, temperature:'Cold', budget:310000, preApproved:false, timeline:'6-12 months', agentId:diana.id, tags:'buyer,first-time', lastContact: new Date(Date.now() - 4*24*60*60*1000) },
    { firstName:'Sandra', lastName:'Wilson', email:'s.wilson@hotmail.com', phone:'(202) 555-0208', source:'Sphere', status:'Under Contract', score:95, temperature:'Hot', budget:720000, preApproved:true, timeline:'Immediately', agentId:sarah.id, tags:'buyer,under-contract', lastContact: new Date(Date.now() - 1*24*60*60*1000) },
    { firstName:'Carlos', lastName:'Hernandez', email:'carlos.h@gmail.com', phone:'(703) 555-0209', source:'Google PPC', status:'New', score:18, temperature:'Cold', budget:null, preApproved:false, timeline:'12+ months', agentId:james.id, tags:'buyer', lastContact: null },
    { firstName:'Patricia', lastName:'Moore', email:'p.moore@gmail.com', phone:'(240) 555-0210', source:'Facebook', status:'Nurturing', score:71, temperature:'Warm', budget:560000, preApproved:true, timeline:'1-3 months', agentId:priya.id, tags:'buyer,pre-approved', lastContact: new Date(Date.now() - 2*24*60*60*1000) },
    { firstName:'Thomas', lastName:'Jackson', email:'tj@gmail.com', phone:'(301) 555-0211', source:'Upnest', status:'New', score:31, temperature:'Cold', budget:445000, preApproved:false, timeline:'6-12 months', agentId:james.id, tags:'buyer', lastContact: null },
    { firstName:'Nancy', lastName:'Davis', email:'nancy.d@gmail.com', phone:'(202) 555-0212', source:'Referral', status:'Hot', score:83, temperature:'Hot', budget:610000, preApproved:true, timeline:'1-3 months', agentId:sarah.id, tags:'seller,buyer,pre-approved', lastContact: new Date(Date.now() - 1*24*60*60*1000) },
  ];
