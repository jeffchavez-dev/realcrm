...
import { Search, Filter, Plus, ChevronRight, Flame, Thermometer, Snowflake, Phone, Mail, Clock } from 'lucide-react';
...
const sources = ['Google PPC','Facebook','Upnest','Homelight','FastExpert','Referral','Sphere'];
  ...
  return (
    <div className="p-6">
      ...
      <div className="flex items-center justify-between mb-6">
        ...
        <button className="btn-primary flex items-center gap-2"><Plus size={16}/>Add Lead</button>
      </div>
            ...
            {loading ? (
              ...
              <tr key={lead.id} className="hover:bg-gray-50 transition-colors">
                ...
                <td className="px-2 py-3">
                  <Link to={`/leads/${lead.id}`} className="p-1.5 text-gray-400 hover:text-blue-600 hover:bg-blue-50 rounded-lg transition-colors inline-flex">
